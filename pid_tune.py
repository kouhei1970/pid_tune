...
ax_gcf = fig.add_subplot(gs[11,26:32],facecolor=axcolor)
ax_pm = fig.add_subplot(gs[12,26:32],facecolor=axcolor)
ax_pcf = fig.add_subplot(gs[13,26:32],facecolor=axcolor)
ax_gm = fig.add_subplot(gs[14,26:32],facecolor=axcolor)
ax_gcf2 = fig.add_subplot(gs[16,26:32],facecolor=axcolor)
ax_pm2 = fig.add_subplot(gs[17,26:32],facecolor=axcolor)
ax_pcf2 = fig.add_subplot(gs[18,26:32],facecolor=axcolor)
ax_gm2 = fig.add_subplot(gs[19,26:32],facecolor=axcolor)
...
k_p = Slider(ax_slider_p, 'P', 0.1, 3.0, valinit=3.0, valstep=0.01)
t_i = Slider(ax_slider_i, 'I', 0.0, 3.0, valinit=3.0, valstep=0.01)
t_d = Slider(ax_slider_d, 'D', 0.01, 0.5, valinit=0.5, valstep=0.001)
